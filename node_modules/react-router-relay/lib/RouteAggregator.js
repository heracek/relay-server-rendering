...
var RouteAggregator = (function () {
  ...
  RouteAggregator.prototype.updateRoute = function updateRoute(_ref3) {
    ...
    routes.forEach(function (route) {
      ...
      _invariant2['default'](_reactRelay2['default'].isContainer(component), 'relay-nested-routes: Route with queries specifies component `%s` ' + 'that is not a Relay container.', component.displayName || component.name);
      ...
      _Object$keys(queries).forEach(function (queryName) {
        ...
        relayRoute.queries[uniqueQueryName] = function () {
  ...
  RouteAggregator.prototype.setFetched = function setFetched(data) {
    this._failure = null;
    this._data = data;
  };
